        ...
        <div className="nsw-grid nsw-grid--spaced">
          <div className="nsw-col nsw-col-md-12">
            ...
            <p className="nsw-content-block__copy">
              Estimate your ESCs and PRCs for the Residential and Small Business Spare Refrigerator
              or Freezer Removal Activity (C1 in the ESS and RF1 in the PDRS) by answering the
              following questions.
            </p>
            <p className="nsw-content-block__copy">
