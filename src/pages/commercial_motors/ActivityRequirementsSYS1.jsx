        ...
        {stepNumber !== 2 && (
          <div className="nsw-grid nsw-grid--spaced">
            <div className="nsw-col nsw-col-md-12">
              ...
              Answer the following questions to check if you meet the eligibility requirements for the Commercial
                Motors Activity for refrigeration or ventilation (F7 in the {' '}
                <a
