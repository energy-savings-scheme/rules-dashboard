      ...
      <div className="nsw-container" style={{ marginBottom: '10%' }}>
        <div className="nsw-grid nsw-grid--spaced">
          <div className="nsw-col nsw-col-md-12">
            ...
            The following questions assess the eligibility requirements for the Commercial Motors (Refrigeration or Ventilation) Activity (F7 in the Energy Savings Scheme and SYS1 in the Peak Demand Reduction Scheme).
            </p>
            <p className="nsw-content-block__copy">
