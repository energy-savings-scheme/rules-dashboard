          ...
          <div class="nsw-layout">
            <div class="nsw-layout__main">
              <div className="nsw-grid nsw-grid--spaced" style={{ fontFamily: 'sans-serif' }}>
                <div className="nsw-col nsw-col-md-12">
                  <p className="nsw-content-block__copy">
                    The Safeguard certificate estimator is a tool that helps you estimate how many
                    certificates you can generate for an activity carried out through the Energy
                    Savings Scheme and the Peak Demand Reduction Scheme. Activities include
                    replacing or installing new equipment or appliances which are more energy
                    efficient.
                  </p>
                  <p className="nsw-content-block__copy">
                    ...
                    <ul>
                      <li>
                        the number of energy savings certificates (ESCs) and peak demand reduction
                      ...
                      <li>
                        how you can benefit from both schemes by demonstrating how ESCs and PRCs
                        work together
                      </li>
                      <li>
                  ...
                  <div style={{ fontFamily: 'sans-serif', paddingTop: '4%' }}>
                    ...
                    <p className="nsw-content-block__copy">
                      Please note the estimator is a guide only and does not ensure eligibility to
                      generate certificates or guarantee that the estimated certificates will apply
                      for every installation. The estimator is based on the latest{' '}
                      <a
                    ...
                    <p className="nsw-content-block__copy">
                      An approved supplier, known as an Accredited Certificate Provider, must be
                      engaged before a project begins to assess scheme feasibility and ensure the
                      accuracy of a submission.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div style={{ fontFamily: 'sans-serif', paddingTop: '4%' }}>
                ...
                <ul>
                  <li>
                    scheme eligibility requirements: does the activity meet the basic scheme
                    requirements{' '}
                  </li>
                  <li>
              ...
              <div style={{ fontFamily: 'sans-serif', paddingTop: '5%' }}>
                ...
                <p className="nsw-content-block__copy">
                  If you are looking to upgrade equipment or appliances in your household or
                  business, you can work with an Accredited Certificate Provider. They will explain
                  the process and help you save on the installation and future energy bills.
                </p>

                <p className="nsw-content-block__copy">
                  Find out what offers are available for your{' '}
                  <a
