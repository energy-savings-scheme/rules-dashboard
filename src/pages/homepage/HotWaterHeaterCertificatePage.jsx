            ...
            <div class="nsw-layout__main">
              <div className="nsw-grid nsw-grid--spaced">
                <div className="nsw-col nsw-col-md-12">
                  ...
                  The Safeguard certificate estimator calculates certificates for replacement of an electric or gas water heater, with an (air source) heat pump or a solar (electric boosted) water heater.{' '}
                  </p>
                </div>
              </div>
            </div>
