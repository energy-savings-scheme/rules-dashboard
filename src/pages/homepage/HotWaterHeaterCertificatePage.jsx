            ...
            <div class="nsw-layout__main">
              <div className="nsw-grid nsw-grid--spaced">
                <div className="nsw-col nsw-col-md-12">
                  ...
                  <p className="nsw-content-block__copy">
                  The Safeguard certificate estimator estimates certificates for replacement of an electric or gas water heater, with an (air source) heat pump or a solar (electric boosted) water heater.                  </p>
                </div>
              </div>
            </div>
          </div>
