        ...
        <div className="nsw-grid nsw-grid--spaced">
          <div className="nsw-col nsw-col-md-12">
            ...
            <p className="nsw-content-block__copy">
              The following questions assess the eligibility requirements for the Refrigerated Cabinet Activity (F1.1 and F1.2 the ESS and RF2 in the PDRS). Answer the questions to check your
