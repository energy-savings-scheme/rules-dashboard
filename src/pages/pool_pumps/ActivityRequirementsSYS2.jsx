...
export default function ActivityRequirementsSYS2(props) {
  ...
  useEffect(() => {
    ...
    formValues
      ...
      var single_speed_input_power_var = formValues.find((item) => item.name === "SYS2_input_power_dropdown")

      if(multiple_speed_var !== undefined && multiple_speed_var.form_value === true && single_speed_input_power_var.form_value === "single_speed"){
        new_arr.push(single_speed_input_power_var);
      }

      if(single_speed_input_power_var !== undefined && multiple_speed_var.form_value === false && single_speed_input_power_var.form_value === "multiple_speed"){
        new_arr.push(single_speed_input_power_var);
      }
